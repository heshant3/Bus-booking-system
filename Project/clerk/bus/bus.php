      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="bus.php">Bus Management</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">  
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Bus Management</h1>
            <div class="row">
              <form class="form" action="conn.php" method="post" autocomplete="on">
                <div class="col-sm-10 col-md-6">
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>Bus ID
                          <input type="text" id="bid" class="form-control form-control-sm" placeholder="" aria-controls="dataTable" required autofocus name="bid">
                        </label>
                    </div>
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>Seat
                    ...
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>Engine Number
                          <input type="text" id="engNum" class="form-control form-control-sm" placeholder="" aria-controls="dataTable" name="engNum">
                        </label>
                    </div>
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>Gear Type
                          <select id="gearTyp" aria-controls="dataTable" class="form-control form-control-sm" name="gearTyp">
                            <option value="">Choose...</option>
                            <option>Auto</option>
                    ...
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>Bus Type
                          <select id="busTyp" aria-controls="dataTable" class="form-control form-control-sm" name="busTyp">
                            <option value="">Choose...</option>
                    ...
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>Facility
                          <input type="text" id="facility" class="form-control form-control-sm" placeholder="" aria-controls="dataTable" name="facility">
                        </label>
                    </div>
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>Other
                          <input type="text" id="other" class="form-control form-control-sm" placeholder="" aria-controls="dataTable" name="other">
                        </label>
                    </div>
                    <br>
                    <table>
