...
<head>
  ...
  <title>ET | Route Management</title>
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="route.php">Route Management</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">  
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Route Management</h1>
            <div class="row">
              <form class="form" action="conn.php" method="post" autocomplete="on">
                <div class="col-sm-10 col-md-6">
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>Route ID
                          <input type="text" id="rid" class="form-control form-control-sm" placeholder="" aria-controls="dataTable" required autofocus name="rid">
                        </label>
                    </div>
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>Origin
                          <select id="origin" aria-controls="dataTable" class="form-control form-control-sm" name="origin">
                    ...
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>From
                          <select id="rouFrom" aria-controls="dataTable" class="form-control form-control-sm" name="rouFrom">
                            <option value="">Choose...</option>
                    ...
                    <div id="dataTable_filter" class="dataTables_filter">
                        <label>To
                          <select id="rouTo" aria-controls="dataTable" class="form-control form-control-sm" name="rouTo">
                            <option value="">Choose...</option>
                            <option>Matale</option>
                            <option>Kandy</option>
                          </select>
